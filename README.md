...
<img align="right" alt="Coding" width="380" src="https://cdn.jsdelivr.net/gh/abhisheknaiidu/abhisheknaiidu@master/code.gif" />

### 🎓 About Me

- 🎓 **Fresh Graduate** in Informatics Engineering from *Universitas Muhammadiyah Gresik (2025)*
- 💻 **Role:** Software Developer | Web Developer | Problem Solver
- 🎯 **Focus:** Building scalable web applications with modern tech stacks.
- 😎 **Fun Fact:** *Kalau bug nggak hilang, biasanya saya coba `npm install patience` dulu.*
...
<p align="left">
  <img src="https://skillicons.dev/icons?i=laravel,php,js,react,tailwind,mysql,figma,git,vscode,postman,bootstrap,html,css" />
</p>
